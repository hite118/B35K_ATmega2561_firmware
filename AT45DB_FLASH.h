...
void GET_USR_INFO_DATA(unsigned int usrcnt)
{
    ...
    switch(usrcnt){
        ...
        case MARKING_VERSION :
            memcpy(&Marking_Version,&(Data_Buff[0]),sizeof(Marking_Version));
            break;
        case ABN_INFO_DATA:
            memcpy(&ABN_INFO,&(Data_Buff[0]),sizeof(ABN_INFO));
            break;
        //case BREAK_OUT_DATA :
...
void PUT_USR_INFO_DATA(unsigned int usrcnt)
{
    ...
    switch(usrcnt){
        ...
        case SYS_INFO_DATA :
            ...
            break;
        case MARKING_VERSION :
            memcpy(&(Data_Buff[0]),&Marking_Version,sizeof(Marking_Version));
            break;
        case ABN_INFO_DATA:
             memcpy(&(Data_Buff[0]),&ABN_INFO,sizeof(ABN_INFO));
            break;
        //case BREAK_OUT_DATA :
