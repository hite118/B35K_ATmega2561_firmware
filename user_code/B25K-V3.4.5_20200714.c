                    ...
                    case CMD_SOLTEST :    //0xB0::솔레노이드, 팩커, 인쇄기 개별 동작 시험
                        switch(RxBuffer[1])
						{
                            ...
                            case 0x0A :
                                ...
                                break;
                            case 0x0B :
                                ExtPort_TEST(0x04, RxBuffer[1]-1,Signal_ON, 0);
                                delay_ms(100);
                                ExtPort_TEST(0x04, RxBuffer[1]-1,Signal_OFF, 0);
                                delay_ms(100);
                                break;
                            case 0x0C :
                                ExtPort_TEST(0x05, RxBuffer[1]-1,Signal_ON, 0);
                                delay_ms(100);
                                ExtPort_TEST(0x05, RxBuffer[1]-1,Signal_OFF, 0);
                                delay_ms(100);
                                break;
                            case 0x0D :
                                ExtPort_TEST(0x06, RxBuffer[1]-1,Signal_ON, 0);
                                delay_ms(100);
                                ExtPort_TEST(0x06, RxBuffer[1]-1,Signal_OFF, 0);
                                delay_ms(100);
                                break;
                            case 0x0E :
                                ExtPort_TEST(0x07, RxBuffer[1]-1,Signal_ON, 0);
                                delay_ms(100);
                                ExtPort_TEST(0x07, RxBuffer[1]-1,Signal_OFF, 0);
                                delay_ms(100);
                                break;
                            case 0x0F :
                                ExtPort_TEST(0x08, RxBuffer[1]-1,Signal_ON, 0);
                                delay_ms(100);
                                ExtPort_TEST(0x08, RxBuffer[1]-1,Signal_OFF, 0);
                                delay_ms(100);
                                break;
                            case 0x10 :
                                ExtPort_TEST(0x09, RxBuffer[1]-1,Signal_ON, 0);
                                delay_ms(100);
                                ExtPort_TEST(0x09, RxBuffer[1]-1,Signal_OFF, 0);
                                delay_ms(100);
                                break;
                            case 0x20 :
                                ExtPort_TEST(0x0A, RxBuffer[1]-1,Signal_ON, 0);
                                delay_ms(100);
                                ExtPort_TEST(0x0A, RxBuffer[1]-1,Signal_OFF, 0);
                                delay_ms(100);
                                break;
                             case 0x30 :
                                ExtPort_TEST(0x0B, RxBuffer[1]-1,Signal_ON, 0);
                                delay_ms(100);
                                ExtPort_TEST(0x0B, RxBuffer[1]-1,Signal_OFF, 0);
                                delay_ms(100);
                                break;
                        }
                        BuzzerOn();
