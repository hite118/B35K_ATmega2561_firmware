...
unsigned char RxBuffer[COM_BUF_MAX], TxBuffer[1500], COM_REV_ENABLE, COM_MOD, TxEnable, TimerMode, adcnt, avr_loop_cnt=10, reformCH, StopEnable=0;
...
void Initialize_REG(void){
    ...
    // INT0 : ON, ANY CHANGE , INT1 : ON, ANY CHANGE
